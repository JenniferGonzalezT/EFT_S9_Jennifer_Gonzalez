...
public class EFT_S9_Jennifer_Gonzalez {
    ...
    static final int CANT_OPCIONES_MENU = 8;
        ...
        do {
            ...
            switch (opcionMenu) {
                ...
                case 8:
                    ...
                    break;
                default:
                    System.out.println("Opción no válida. Recuerde ingresar un número del 1 al " + CANT_OPCIONES_MENU + ".");
                    break;
            }
        } while (opcionMenu != CANT_OPCIONES_MENU); //siendo salir siempre la última opción
    }
